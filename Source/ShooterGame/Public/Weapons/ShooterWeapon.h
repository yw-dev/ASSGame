...
struct FWeaponData
{
	...
	UPROPERTY(EditDefaultsOnly, Category = WeaponStat)
	EShooterWeaponType ActiveWeaponType;
	...
	FWeaponData()
	{
		...
		ActiveWeaponType = EShooterWeaponType::None;
	}
};

UCLASS(Blueprintable)
class AShooterWeapon : public AShooterWeaponBase
{
	GENERATED_BODY()
...
public:
	...
	//EShooterWeaponType GetActiveWeaponType() const;
