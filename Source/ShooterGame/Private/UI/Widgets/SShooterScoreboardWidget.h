...
protected:
	...
	/** makes Grid view widget for Player data */
	TSharedRef<SWidget> MakePlayerTableView() const;

	/** makes Grid Title row widget */
	TSharedRef<SWidget> MakePlayerTitleRow() const;
	...
	/** holds player info rows */
	TSharedPtr<SHorizontalBox> ScoreboardTitleRow;
