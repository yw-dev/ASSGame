...
struct FShooterMenuItemStyle : public FSlateWidgetStyle
{
	...
	/**
	 * The image used for the Tab Top arrow
	 */
	UPROPERTY(EditAnywhere, Category = Appearance)
	FSlateBrush TopArrowImage;
	FShooterMenuItemStyle& SetTopArrowImage(const FSlateBrush& InTopArrowImage) { TopArrowImage = InTopArrowImage; return *this; }

	/**
	 * The image used for the Tab Bottom arrow
	 */
	UPROPERTY(EditAnywhere, Category = Appearance)
	FSlateBrush BottomArrowImage;
	FShooterMenuItemStyle& SetBottomArrowImage(const FSlateBrush& InBottomArrowImage) { BottomArrowImage = InBottomArrowImage; return *this; }
};
