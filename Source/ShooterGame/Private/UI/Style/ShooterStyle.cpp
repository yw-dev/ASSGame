...
TSharedRef< FSlateStyleSet > FShooterStyle::Create()
{
	...
	Style.Set("ShooterGame.MessageTextStyle", FTextBlockStyle()
		.SetFont(TTF_FONT("Fonts/Roboto-Medium", 14))
		.SetColorAndOpacity(FLinearColor::White)
		.SetShadowOffset(FIntPoint(-1, 1))
	);
	...
	Style.Set("ShooterGame.DefaultScoreboard.Row.TitleTextStyle", FTextBlockStyle()
		.SetFont(TTF_FONT("Fonts/Roboto-Black", 14))
		.SetColorAndOpacity(FLinearColor::White)
		.SetShadowOffset(FVector2D(0, 1))
	);

	Style.Set("ShooterGame.DefaultScoreboard.Row.ItemTextStyle", FTextBlockStyle()
