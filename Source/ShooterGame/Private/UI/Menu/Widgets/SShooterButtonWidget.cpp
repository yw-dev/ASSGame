...
#include "SShooterButtonWidget.h"
#include "ShooterStyle.h"
#include "ShooterMenuItemWidgetStyle.h"


// Sets default values
void SShooterButtonWidget::Construct(const FArguments& InArgs)
{
	...
	[
		...
		[
			...
			[
				SNew(SImage)
				.ColorAndOpacity(this, &SShooterButtonWidget::GetButtonBgColor)
		...
		[
			...
			.ColorAndOpacity(this, &SShooterButtonWidget::GetButtonTextColor)
			.ShadowColorAndOpacity(this, &SShooterButtonWidget::GetButtonTextShadowColor)
			.Text(Text)
		]
		+ SOverlay::Slot()
		.HAlign(HAlign_Right)
		...
		[
			...
			[
				...
				.Visibility(this, &SShooterButtonWidget::GetLeftArrowVisibility)
				.OnMouseButtonDown(this, &SShooterButtonWidget::OnLeftArrowDown)
				[
					SNew(SOverlay)
					+ SOverlay::Slot()
			...
			+ SHorizontalBox::Slot()
			.AutoWidth()
			.Padding(TAttribute<FMargin>(this, &SShooterButtonWidget::GetOptionPadding))
			[
				SNew(STextBlock)
				.TextStyle(FShooterStyle::Get(), "ShooterGame.MenuTextStyle")
			...
			[
				...
				.Visibility(this, &SShooterButtonWidget::GetRightArrowVisibility)
				.OnMouseButtonDown(this, &SShooterButtonWidget::OnRightArrowDown)
				[
					SNew(SOverlay)
					+ SOverlay::Slot()
					.HAlign(HAlign_Center)
...
FReply SShooterButtonWidget::OnRightArrowDown(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
...
FReply SShooterButtonWidget::OnLeftArrowDown(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
	FReply Result = FReply::Unhandled();
...
EVisibility SShooterButtonWidget::GetLeftArrowVisibility() const
{
	return LeftArrowVisible;
}

EVisibility SShooterButtonWidget::GetRightArrowVisibility() const
{
	return RightArrowVisible;
}

FMargin SShooterButtonWidget::GetOptionPadding() const
{
	return RightArrowVisible == EVisibility::Visible ? FMargin(0) : FMargin(0, 0, ItemMargin, 0);
}

FSlateColor SShooterButtonWidget::GetButtonTextColor() const
{
	FLinearColor Result;
...
FLinearColor SShooterButtonWidget::GetButtonTextShadowColor() const
{
	FLinearColor Result;
	if (bIsActiveMenuItem)
	{
...
FSlateColor SShooterButtonWidget::GetButtonBgColor() const
{
...
FReply SShooterButtonWidget::OnMouseButtonDown(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
...
FReply SShooterButtonWidget::OnMouseButtonUp(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
	return FReply::Handled();
}

void SShooterButtonWidget::SetMenuItemActive(bool bIsMenuItemActive)
{
	this->bIsActiveMenuItem = bIsMenuItemActive;
}

void SShooterButtonWidget::UpdateItemText(const FText& UpdatedText)
{
	Text = UpdatedText;
