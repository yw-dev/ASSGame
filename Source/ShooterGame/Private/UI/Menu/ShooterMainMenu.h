...
#include "Widgets/SShooterOptionWidget.h"
#include "Widgets/SShooterSessionsWidget.h"
#include "Widgets/SShooterPawnGuideWidget.h"
...
protected:
	...
	/** server list widget */
	TSharedPtr<class SShooterSessionsWidget> SessionListWidget;

	/** System Option widget */
	TSharedPtr<class SShooterOptionWidget> OptionWidget;
