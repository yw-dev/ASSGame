...
#include "Widgets/SShooterMainViewWidget.h"
...
class FShooterMainView : public TSharedFromThis<FShooterMainView>, public FTickableGameObject
{
public:

	virtual ~FShooterMainView();
...
protected:
	...
	/** Main View widget */
	TSharedPtr<class SShooterMainViewWidget> MainView;

	/** menu widget */
	TSharedPtr<class SShooterMenuWidget> MenuWidget;

	/* used for removing the MainView */
	TSharedPtr<class SWeakWidget> MainViewContainer;
