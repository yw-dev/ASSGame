...
class FShooterShopMenu : public TSharedFromThis<FShooterShopMenu>
{
public:
...
protected:
	...
	TSharedPtr<FShooterTabItem> RootMenuItem;

	/** main menu item pointer */
	TSharedPtr<FShooterTabItem> MainMenuItem;

	/** HUD menu widget */
	TSharedPtr<class SShooterTabWidget> GameMenuWidget;

	/** if game menu is currently opened*/
	bool bIsGameMenuUp;

	/** holds cheats menu item to toggle it's visibility */
	TSharedPtr<class FShooterTabItem> CheatsMenu;
